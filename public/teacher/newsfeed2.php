                            ...
                            <tr>
                                ...
                                <td class="time">
                                    <p class="d"> <?php echo $row['newsDate']?>
                                        <span><?php echo  $row['newsTime']?></span></p>
                                </td>
        ...
        <div id="page1" class="page">
            ...
            <table class="none">
                <tr class="none">
                    ...
                    <td class="none">
                        <button class="view-btn old"><span><a href="#old"><i class="fa fa-arrow-down"
                                        aria-hidden="true"></i></a></span></button>
                    </td>
                </tr>
            </table>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="message">
                        ...
                        <p>From October 31 through December 31, we invite you to Do Something for CancerCare: Tell your
                            family and friends about CancerCare over your Zoom turkey dinners. Bake holiday cookies.</p>

                        <button class="view-btn"><span><a href="notification.php"><b>View
                                        Message</b></a></span></button>
            ...
            <table class="none">
                <tr class="none">
                    ...
                    <td class="none">
                        <button class="view-btn old"><span><a href="#new"><i class="fa fa-arrow-up"
                                        aria-hidden="true"></i></a></span></button>
                    </td>
                </tr>
            </table>
...
} else if (url == "http://localhost/CL-GEN/public/teacher/newsfeed2.php#old") {
    page1.style.display = "none";
    page2.style.display = "block";
    button1.style.color = "#008080";
    button2.style.color = "#000";

} else if (url == "http://localhost/CL-GEN/public/teacher/newsfeed2.php#new") {
    page1.style.display = "none";
    page2.style.display = "block";
    button1.style.color = "#008080";
    button2.style.color = "#000";
