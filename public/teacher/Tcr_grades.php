...
<div id="nav1"></div>
     ...
     <div class="content-area">
        ...
        <div class="button-area">
        <h3>ADVANCED LEVEL SECTION-I</h3>
         ...
         <div class="button-area">
        <h3>ADVANCED LEVEL  SECTION-II</h3>
            <button class="btn"><a href="Tcr_grades2.php">Grade 13-Bio</a></button>
