...
?>
                                ...
                                <td>
                                    ...
                                    <table class="inner">
                                        <tr>
                                            ...
                                            <td class="time">
                                                <p class="d"> <?php echo $row['newsDate'] ?> : <?php echo  $row['newsTime'] ?>
                                                </p>
                                            </td>
    ...
    <script>
        ...
        if (url == "http://localhost/CL-GEN/public/teacher/newsfeed.php") {
            page1.style.display = "none";
            page2.style.display = "block";
            ...
            button1.style.color = "#008080";
            button2.style.color = "#000";
        } else if (url == "http://localhost/CL-GEN/public/teacher/newsfeed.php#old") {
            page1.style.display = "none";
            page2.style.display = "block";
            button1.style.color = "#008080";
            button2.style.color = "#000";

        } else if (url == "http://localhost/CL-GEN/public/teacher/newsfeed.php#new") {
            page1.style.display = "none";
            page2.style.display = "block";
            button1.style.color = "#008080";
            button2.style.color = "#000";
