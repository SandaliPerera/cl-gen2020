...
<div id="nav"></div>
	...
	<div class="feed">
		...
		<div id="page1" class="page">
            ...
            <h3>Requested Character Certificates</h3>
				<hr>
				<form class="search" action="o_addStudentDetails.html">
                 ...
                 <table>
                        ...
                        <tr>
                            ...
                            <button id="character-btn" class="btn editbtn">Open Form</button>
                            ...
                            <td><form><button class="btn editbtn" type="submit" >Generate Character Certificate</button></form></td>
		...
		<div id="page2" class="page">
            ...
            <h3>Character Certificates with Issues</h3>
				<hr>
				<form class="search" action="o_addStudentDetails.html">
                    <input type="text" placeholder="Search.." name="search">
                    <button type="submit">Search</button>
                        ...
                        <tr>
                            ...
                            <button id="character-btn" class="btn editbtn">View Issue</button>
                                <div id="character-form" class="model">
                                    <div class="modal-content">
                                        <span class="close1">&times;</span>
                                        <h2>Issues of the Character Certificate</h2>
                                        <form>
                                        <hr>
                                            <label for="userID"><b>Student Admission Number</b></label>
                                            <input type="text" value="ST2000001" name="id">
                            ...
                            <td><form><button class="btn editbtn" type="submit" >Generate New Character Certificate</button></form></td>
                            <td><button class="btn dltbtn" type="button">Reject</button></td>
                            <td>
		...
		<div id="page3" class="page">
            ...
            <h3>Accepted Character Certificates</h3>
				<hr>
				<form class="search" action="o_addStudentDetails.html">
                    <input type="text" placeholder="Search.." name="search">
                    <button type="submit">Search</button>
